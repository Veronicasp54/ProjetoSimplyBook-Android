...
package com.example.myapplication.activity.projetocontrolesalas.utils;
...
public class TinyDB {
    ...
    public ArrayList<Sala> getListSalaObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Sala> objects =  new ArrayList<Sala>();

    	for(String jObjString : objStrings){
    		Sala value  = gson.fromJson(jObjString,  Sala.class);
    		objects.add(value);
    	}
    	return objects;
    }
